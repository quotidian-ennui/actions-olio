...
|     gradle-dependency-graph      | string |  false   | `"automatic"` | The gradle action dependency graph value. Valid values are 'automatic' (default generate-and-submit if writeable=true),'disabled','generate','generate-and-submit','generate-submit-and-upload','generate-and-upload','download-and-submit') |
